      ...
      <div key={index} className="grid grid-cols-2 gap-4 bg-lightBg rounded-lg overflow-hidden shadow-md mx-8 my-10">
        ...
        <div className="col-span-1 p-4 flex flex-col justify-between">
          ...
          <div className="flex justify-between items-center mb-4">
            <span className="text-font font-bold mx-28">{`$ ${car.price}`}</span>
            <button className='bg-primary text-darkBg px-6 py-3 rounded-md hover:bg-primaryHover transition-colors'>Select</button>
          </div>
        </div>
      </div>
    ));
